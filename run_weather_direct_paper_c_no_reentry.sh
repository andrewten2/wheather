...
export WEATHER_BOT_LIVE_MAX_POSITION_USD="${WEATHER_BOT_LIVE_MAX_POSITION_USD:-3.00}"
export WEATHER_BOT_NO_MAX_POSITION_USD="${WEATHER_BOT_NO_MAX_POSITION_USD:-2.00}"
export SIMMER_WEATHER_MAX_POSITION_USD="${SIMMER_WEATHER_MAX_POSITION_USD:-3.00}"
